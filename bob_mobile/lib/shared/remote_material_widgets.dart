...
LocalWidgetLibrary createRemoteMaterialWidgets() =>
...
Map<String, LocalWidgetBuilder> get _materialWidgetsDefinitions =>
    <String, LocalWidgetBuilder>{
      ...
      'ImageNetwork': (BuildContext context, DataSource source) {
      ...
      'MaterialIcon': (BuildContext context, DataSource source) {
        return Icon(
          IconData(source.v<int>(['codePoint']) ?? 0xf04b6,
